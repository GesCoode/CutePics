...
<button
  class="relative flex justify-center items-center gap-2 flex-1 px-5 py-[7px] font-sans text-[14px] leading-normal tracking-[-0.266px] overflow-hidden transition-colors duration-150
        {rounded ? 'rounded-lg' : 'rounded-[2px]'}
